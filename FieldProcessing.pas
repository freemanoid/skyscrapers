...
procedure FillRowAscending (var SomeRow: array of byte; MaxValue: byte);
var
  itr: byte;
begin
...
procedure FillRowDescending (var SomeRow: array of byte; MaxValue: byte);
var
  itr: byte;
begin
...
procedure FillColumnAscending (var SomeArray: Field.TUnitsArray ; ColumnNumber, MaxValue: byte);
var
  itr: byte;
begin
  for itr:= 0 to MaxValue - 1 do
    SomeArray[itr][ColumnNumber]:= itr + 1;
end;

procedure FillColumnDescending (var SomeArray: Field.TUnitsArray; ColumnNumber, MaxValue: byte);
var
  itr: byte;
begin
  for itr:= MaxValue - 1 downto 0 do
