...
procedure AddPlacedVariant (Variant, Row, Col: byte);
begin
  PlacedVariants[Row][Col][Variant]:= true;
end;

procedure RemovePlacedVariant (Variant, Row, Col: byte);
begin
  PlacedVariants[Row][Col][Variant]:= false;
end;

procedure RemoveAllPlacedVariantsExcept (Variant, Row, Col, FieldSize: byte);
var
  itrVariant: byte;
begin
